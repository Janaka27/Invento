    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">Track and manage your stock levels across all warehouses</p>
        </div>
        {canWrite && (
      ...
      {editingItem && (
        <Dialog open={!!editingItem} onOpenChange={() => setEditingItem(null)}>
          <DialogContent className="max-w-2xl">
            ...
            <InventoryForm initialData={editingItem} onSubmit={handleEditItem} isEditing />
          </DialogContent>
        </Dialog>
      )}
    </div>
...
function InventoryForm({ initialData, onSubmit, isEditing = false }) {
